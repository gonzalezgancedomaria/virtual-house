...
export class VirtualPanoramaViewComponent implements AfterViewInit, OnChanges{
  @Input() viewId: string;
  ...
  ngOnChanges(changes: SimpleChanges): void {
    if (changes['pannellumService'] && changes['pannellumService'].currentValue.sceneJson) {
      console.log('La propiedad sceneJson ha cambiado');
      console.log('Nuevo valor:', changes['pannellumService'].currentValue.sceneJson);
    }
  }
