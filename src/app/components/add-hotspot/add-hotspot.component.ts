...
export class AddHotspotComponent {
  ...
  constructor(
    private sensorService: SensorServiceService, 
    private dialog: MatDialog, 
    private service: PannellumService,
    private snackBar: MatSnackBar){
    this.measureUnits = this.sensorService.measureUnits;
  ...
  public saveHotspot() {
    ...
    if(!error){       
      ...
      this.service.addHotspot([this.tour.pins[0].x, this.tour.pins[0].y]);
